...
* infrastruttura di rete:
    ...
    > * DMZ e frammentazione della rete (2 subnet), WIFI mesh con tre acess point
...
* dati trattati:
  ...
  * dati penali
  * dati che presentano rischi elevati
In base alla particolarità dei dati trattati viene applicata una policy specifica per il loro trattamento e smaltimento.
...
| **3. dati clienti che alimentano ai (comuni)**              | Data Breach, Data poisoning, furto di proprietà intelletuale, ramsowere     | 3     | 2             | 6       | cifratura del disco, frammentazione dei dati, DC che gestisce la granularità dei permessi, audit e data sanitization.              |  2       | 1     | 2        |
...
| **8. log di sistema**               | Data Breach, furto di proprietà intellettuale, ramsower, log tampering    | 4 | 5      | 20   |  DC che gestisce la granularità dei permessi, sistema di monitoraggio (alert).      |  3           | 5     |     15      |

![tabella_rischio](tabella_rischio.png)
